  ...
  if len(poles[middle]) > 2:
    if poles[left][-1] == -1 and poles[right][-1] == -1:
      if tall % 2 == 0:
        ...
        distribution_order='right'
      else:
        poles[left].append(poles[middle].pop())
        poles[right].append(poles[middle].pop())
        distribution_order='left'
      print(2,poles)
    else:
      if distribution_order == 'left':
        poles[left].append(poles[middle].pop())
        poles[right].append(poles[middle].pop())
      if distribution_order == 'right':
        poles[right].append(poles[middle].pop())
        poles[left].append(poles[middle].pop())
